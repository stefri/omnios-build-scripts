...
VER=1.1.28
VERHUMAN=$VER
PKG=mawi/library/libxslt
SUMMARY="Libxslt is the XSLT C library developed for the GNOME project."
DESC="$SUMMARY ($VER)"
...
CONFIGURE_OPTS="--disable-static --with-pic --without-crypto --without-python"
