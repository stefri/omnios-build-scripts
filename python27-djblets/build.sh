...
VER=0.6.28
VERHUMAN=$VER
PKG=library/python-27/djblets
SUMMARY="A collection of useful extensions for Django"
DESC="Djblets is a set of utility classes and functions for web applications written using Django and Python."
...
RUN_DEPENDS_IPS="runtime/python-27 library/python-27/django"
