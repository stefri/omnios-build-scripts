...
VER=1.1.7
VERHUMAN=$VER
PKG=library/python-27/pil
SUMMARY="Python Imaging Library (PIL)"
DESC="The Python Imaging Library (PIL) adds image processing capabilities to your Python interpreter. This library supports many file formats, and provides powerful image processing and graphics capabilities."

# uulm.mawi python is 64-bit only
BUILDARCH=64
#LDFLAGS64="-L$PYTHONLIB -R$PYTHONLIB -L/usr/local/lib/$ISAPART64 -R/usr/local/lib/$ISAPART64 -L/usr/lib/$ISAPART64 -R/usr/lib/$ISAPART64"
