...
MIRROR=http://scott.mathematik.uni-ulm.de/src
...
# Full paths to bins
PERLBIN=/opt/perl5/5.20.2/bin
PERL32=/usr/perl5/5.20.2/bin/$ISAPART/perl
PERL64=/usr/perl5/5.20.2/bin/$ISAPART64/perl
...
PERL_MAKEFILE_OPTS="INSTALLSITEBIN=$PREFIX/perl5/bin/_ARCHBIN_ \
                    ...
                    INSTALLSITEMAN1DIR=$PREFIX/perl5/share/man/man1 \
                    INSTALLSITEMAN3DIR=$PREFIX/perl5/share/man/man3 \
                    INSTALLDIRS=site"
...
# Linker flags
LDFLAGS=""
LDFLAGS32="-L${PREFIX} -R${PREFIX}/lib -L/usr/local/lib"
